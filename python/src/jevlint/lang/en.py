"""
Every message in English, which is the list a locale file is filled in against.

Patterns are ICU MessageFormat. A locale file needs only the keys it translates,
and anything absent is read from here.
"""
